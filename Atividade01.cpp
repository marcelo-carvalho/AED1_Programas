...
{
    date people[10];
    date oldest {"Errado", INT_MIN, INT_MIN, INT_MIN, INT_MIN};
    date youngest = {"Errado", INT_MAX, INT_MAX, INT_MAX, INT_MAX};
    ...
    for (int i = 0; i < 10; i++){
        ...
        cout << "Oldest Person: " << oldest.name << " Age: " << oldest.age << endl;
        cout << "Youngest Person: " << youngest.name << " Age: " << youngest.age << endl;
        return 0;
}